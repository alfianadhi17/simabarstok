...
<html lang="en">
    <head>
        ...
        <title>SIMABAR Daftar Stok</title>
                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idb;?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="updatebarang">Kirim</button>
                                                </div>
                                                </form>
        ...
        <script src="js/datatables-simple-demo.js"></script>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-success" name="addnewbarang">Kirim</button>
                </div>
                </form>
