                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$iduser;?>">
                                                ...
                                                <div class="modal-body">
                                                    <input type="email" name="emailadmin" value="<?=$em;?>" class="form-control" placeholder="Email">
                                                    <br>
                                                    <input type="password" name="passwordbaru" class="form-control" value="<?=$pw;?>" placeholder="Password">
                                                    <br>
                                                    <input type="hidden" name="id" value="<?=$iduser;?>">
                                                    <button type="submit" class="btn btn-success" name="updateadmin">Kirim</button>
                                                </div>
                                                </form>
        ...
        <script src="js/datatables-simple-demo.js"></script>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-success" name="addadmin">Kirim</button>
                </div>
                </form>
