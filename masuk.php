...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-priary bg-light">
                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idm;?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="updatebarangmasuk">Kirim</button>
                                                </div>
                                                </form>
...
<div class="modal fade" id="myModal">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <button type="submit" class="btn btn-success" name="barangmasuk">Kirim</button>
                </div>
                </form>
